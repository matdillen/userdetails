...
%{--</div>--}%
    ...
    <label for="organisation"><g:message code="user.form.organisation" /></label>
    <input id="organisation" name="organisation" type="text" class="input-xlarge" value="${props?.organisation}"/>

    <label for="city"><g:message code="user.form.city" /></label>
    <input id="city" name="city" type="text" class="input-xlarge" value="${props?.city}" />

    <%--
    <label for="state"><g:message code="user.form.state" />State/territory</label>
    ...
    <label for="telephone"><g:message code="user.form.telephone" /></label>
    <input id="telephone" name="telephone" type="text" class="input-xlarge" value="${props?.telephone}" />
<%--
    <label for="primaryUserType"><g:message code="user.form.primary_usage" /></label>
    ...
    <label for="secondaryUserType"><g:message code="user.form.secondary_usage" /></label>
